					...
					<tbody>
						<c:forEach var="file" items="${cityAndCityFile.list}">
							<tr>
								...
								<td>${file.fileExt }</td>
								<td>${file.fileSize }</td>													
								<td><a href="${pageContext.request.contextPath}/city/cityUpdate?cityId=${file.cityId}">수정</a></td>
								<td><a href="${pageContext.request.contextPath}/city/cityDelete?cityId=${file.cityId}">삭제</a></td>
							</tr>
						</c:forEach>
					</tbody>
				</table>
