        ...
        <div class="row">
          <div class="col-sm-6 col-lg-6">
			...
			<c:if test="${currentPage>1}">
				<a href="${pageContext.request.contextPath}/city/cityList?currentPage=${currentPage-1}&rowPerPage=${rowPerPage}">이전</a>
			</c:if>
			${currentPage}
			<c:if test="${currentPage<lastPage}">
				<a href="${pageContext.request.contextPath}/city/cityList?currentPage=${currentPage+1}&rowPerPage=${rowPerPage}">다음</a>
			</c:if>
		</div>
          </div>
          </div>
